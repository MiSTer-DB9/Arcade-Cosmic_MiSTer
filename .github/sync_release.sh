...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Cosmic_MiSTer.git"
CORE_NAME=(Arcade-Cosmic)
...
UPSTREAM_CORE_NAME=(Arcade-Cosmic)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Cosmic.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Cosmic.rbf)
